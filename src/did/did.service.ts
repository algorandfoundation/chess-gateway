...
import { APP_ACCOUNT_BASE_MBR_MICROALGOS, topUpFromSender } from '../../libs/algorand';
 ...
 *   - the **controller** DID (the manager today, future
 *     CREDEBL-onboarded organisations tomorrow), via
...
export class DidService {
   ...
   * as 503 via `mapUpstreamError` (see `managerToken.getToken()` /
   * `vaultService.kvRead`).
   */
